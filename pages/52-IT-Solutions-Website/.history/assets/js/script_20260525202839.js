...
// wheel and touchmove for snappier visibility updates on some devices
window.addEventListener('wheel', () => window.requestAnimationFrame(updateGoTopVisibility), { passive: true });
window.addEventListener('touchmove', () => window.requestAnimationFrame(updateGoTopVisibility), { passive: true });
